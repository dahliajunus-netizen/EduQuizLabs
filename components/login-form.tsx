...
export function LoginForm() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      console.log('[Login] User returned from database:', user);
      console.log('[Login] Detected user ID:', userId);
      ...
      if (
        ...
        console.error('[Login] User has no usable ID.', user);
        setSubmitting(false);
        setError(
  ...
  return (
    <div className="relative flex flex-col gap-6">
      ...
      {error && (
        <div className="rounded-md bg-red-500/10 p-3 text-sm font-medium text-red-500">
          {error}
        </div>
      )}

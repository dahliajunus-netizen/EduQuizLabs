-- Final API grant hardening for browser-facing assessment tables.
-- Anonymous access remains available only on deliberately public live-quiz
-- surfaces. RLS still controls authenticated row access.
